...
local PlaceAliases = {
    ...
    [116495829188952] = {Name = "Dead Rails Lobby", Script = "DeadRails"},
    [70876832253163] = {Name = "Dead Rails Game", Script = "DeadRails"},
...
local function isDeadRailsGame()
    ...
    if deadRailsIds[placeId] then return true end
    if deadRailsIds[gameId] then return true end
    ...
    if success and placeName then
        local lowerName = placeName:lower()
        if lowerName:find("dead rails") then return true end
    end
...
showKeySystem(function()
    if isDeadRailsGame() then
        ...
        createLabel(s, "PlaceId: "..tostring(game.PlaceId))
        createLabel(s, "GameId: "..tostring(game.GameId))
